...
#    Updated: 2022/09/01 23:56:04 by just-a-guy          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
gcc -o source $FILE
./source "My horse is Amazing."  | cat -e > sourcexam    #TESTING
rm source
cd ../../rendu
{
gcc -o final $FILE
./final "My horse is Amazing."  | cat -e > finalexam     #TESTING
mv finalexam ../.system/grading/
rm final
}  &>/dev/null
cd ../.system/grading
...
gcc -o source $FILE
./source "hello" "bye" | cat -e > sourcexam    #TESTING
rm source
cd ../../rendu
{
gcc -o final $FILE
./final "hello" "bye"  | cat -e > finalexam     #TESTING
mv finalexam ../.system/grading/
rm final
}  &>/dev/null
cd ../.system/grading
