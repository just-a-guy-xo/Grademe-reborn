...
void exam::exam_random_show(void)
{
    ...
    if (level == 0)
        ...
        pot_pts = level_per_ex_save; // fixed per-exercise points
...
void exam::info(void)
{
    ...
    std::cout << std::endl
              << "Assignment: " << LIME << current_ex->get_name() << RESET << " for " << LIME << BOLD << level_per_ex_save << RESET << "xp" <<RESET << ", ";
...
void exam::infovip(void)
{
    ...
    std::cout << std::endl
              << "Your current assignment is " << LIME << current_ex->get_name() << RESET << " for " << LIME << (int)level_per_ex_save << RESET << " potential points" << std::endl;
...
int exam::stud_or_swim(void)
{
    ...
    while (choice != "1")
    {
        ...
        if (vip)
            std::cout << "        Get " << LIME << "Ready" << WHITE << BOLD << " " << RESET << std::endl << std::endl;
        else
            std::cout << "     Made by " << LIME << "just-a-guy" << RESET << std::endl
                      << std::endl
                      << std::endl;
        ...
        std::cout << WHITE << BOLD << "    |" << RESET << BOLD << "  SETTINGS  " << WHITE << BOLD << "|" << RESET << BOLD << std::endl
                  << "     \\ ------------ /" << std::endl
                  << std::endl
                  << std::endl;
